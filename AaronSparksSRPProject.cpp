...
void SRP()
{
    ...
    const ZZ B_minus = conv<ZZ>("");
    const ZZ gA = fastModExp(g, a, P);
    cout << "gA: " << gA << endl;

    // Given password and salt
    const string password = "homologic";
    const string salt_hex = "1729e8ab";
